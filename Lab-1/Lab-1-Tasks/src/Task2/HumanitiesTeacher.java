...
public class HumanitiesTeacher extends Teacher {
    ...
    public HumanitiesTeacher(String name, int age, String institute, String field, String courseName,
            String designation) {
    ...
    public static HumanitiesTeacher getHumanitiesTeacherData() {
        ...
        scanner.close();
        var humanitiesTeacher = new HumanitiesTeacher(name, age, institute, field, courseName, designation);
        return humanitiesTeacher;
    }
