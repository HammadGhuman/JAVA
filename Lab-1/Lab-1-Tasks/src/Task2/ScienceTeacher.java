...
public class ScienceTeacher extends Teacher {
    ...
    public ScienceTeacher(String name, int age, String institute, String field, String courseName,
            String designation) {
    ...
    public static ScienceTeacher getHumanitiesTeacherData() {
        ...
        scanner.close();
        var scienceTeacher = new ScienceTeacher(name, age, institute, field, courseName, designation);
